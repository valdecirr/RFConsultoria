        ...
        <form method="POST" action="atualizardados.php">
            <div class="conteudo">
                ...
                <div style="font-size: 20px;font-weight: bold;">
                    ...
                    <label><? echo $row['ID'] ?></label>
                    <input type="hidden" class="form-control" id="idID" name="resultID" value="<? echo $row['ID'] ?>">
                </div>
                <div class="form-row">
                ...
                <div class="form-row" style=" display: flex; justify-content: flex-end;">
                    <button class="btn btn-primary" name="update" id="submit" type="submit">Atualizar</button>
                </div>
            </div>
        </form>
    </main>
